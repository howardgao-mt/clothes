...
$(document).ready(function(){
	...
	$("#useremail").blur(function(){
		...
		if(email == "") {
			...
			dataType : 'json',
			error:function() {
				$("#useremailDiv").html("<font color='red'>系統錯誤!請聯絡系統管理員.</font>");
			},
	...
	$("#sub").click(function(){
		if(checkEmail && checkName && checkPwd && checkCell && checkAddr ) {
			return true;
		} else {
			return false;
		}
  ...
  <body>
	<div class="main" align="center">
		<br>
		<a href="login_Page.action" >回登錄頁面</a>
		<br><br>
		<s:form action="register" method="post" theme="simple">
			...
			<fieldset>
				...
				<table>
					...
					<tr>
						<th>請輸入驗證碼: </th>
						<td><img src="jcaptcha.jpg" /> <input type="text" name="jcaptcha" value="" /></td>
					</tr>
				</table>	
			</fieldset>
			<br>
			<input id="sub" type="submit" class="submit_btn" value="會員註冊"/>
		</s:form>
	</div>
  </body>
</html>
